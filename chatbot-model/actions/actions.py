    ...
    def run(self, dispatcher: CollectingDispatcher,
        ...
        if x == "cvv":
            ...
            dispatcher.utter_message(
                text="The name you are entering must be full name")
        elif x == "bank":
            ...
            dispatcher.utter_message(
                text="Card number will be mentioned on the card itself!")
        elif x == "expiry":
            dispatcher.utter_message(
                text="Expiry Date will be mentioned on the card itself!")
        else:
            dispatcher.utter_message(
                text="Try out for tutorial for more information")
